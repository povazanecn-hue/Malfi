...
export default function PasswordGate({ children }) {
  ...
  // Not logged in — show coming soon + Google login
  return (
      ...
      >
        ...
        <div className="bg-white border border-olive/15 rounded-3xl p-8 shadow-sm">
          ...
          <p className="text-text-light text-sm mb-8 leading-relaxed">
            ...
            Prihláste sa pre skorý prístup.
          </p>

          <button
            onClick={() => base44.auth.loginWithProvider('google', window.location.href)}
            className="w-full flex items-center justify-center gap-3 bg-white border border-olive/25 hover:border-olive/50 rounded-2xl px-5 py-3.5 text-text-dark text-sm font-semibold transition-all hover:shadow-sm"
          >
